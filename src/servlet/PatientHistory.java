...
/**
 * Servlet implementation class PatientHistory
 */
...
public class PatientHistory extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PatHistoryDto patHistoryDto=new DoctorService().getpathistory(patientDto);
		 response.setContentType("application/json");
	        response.setCharacterEncoding("UTF-8");
	        response.getWriter().write(new Gson().toJson(patHistoryDto));
